...
from extract_syl_mapping import get_sound_mapping_distance
import os
import lzma
import pickle
...
def score_function(czech_sections : list[list[str]], english_sections : list[list[str]]) -> float:
    ...
    sound_mapping_distance = get_sound_mapping_distance(czech_sections, english_sections)
    print("sound mapping distance: ", sound_mapping_distance)
    score.append(sound_mapping_distance)
